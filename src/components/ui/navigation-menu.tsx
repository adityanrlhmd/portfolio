...
const navigationMenuTriggerStyle = cva(
  'text-muted-foreground hover:text-foreground data-[active=true]:text-foreground group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-xs/relaxed font-medium transition-all outline-none focus:text-foreground focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:text-muted-foreground data-popup-open:hover:text-foreground data-open:text-muted-foreground data-open:hover:text-foreground data-open:focus:text-foreground'
);
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          'isolate z-50 h-(--positioner-height) w-(--positioner-width) max-w-(--available-width) transition-[top,left,right,bottom] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)] data-instant:transition-none data-[side=bottom]:before:inset-s-0 data-[side=bottom]:before:inset-e-0 data-[side=bottom]:before:top-[-10px]',
          className
        )}
        {...props}
      >
